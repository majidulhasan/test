...
const LockScreen: React.FC<Props> = ({ isDarkMode, onUnlock, isFirstTime, onSetMasterPassword, savedSecurityQuestions = [], pinLength = 4 }) => {
  ...
  return (
    <div className={`fixed inset-0 z-[100] flex flex-col transition-all duration-700 overflow-y-auto no-scrollbar ${isUnlocking ? 'scale-110 opacity-0 pointer-events-none' : 'scale-100 opacity-100'} ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      <div className="w-full max-w-sm mx-auto p-8 pt-16 flex flex-col items-center flex-grow">
        
        {/* Header Icon - Added margin and centered */}
        <div className={`w-24 h-24 mb-10 rounded-[2rem] flex items-center justify-center shadow-2xl transition-all duration-500 transform flex-shrink-0 ${
        ...
        <h1 className="text-3xl font-black mb-10 tracking-tight text-center">PassNest</h1>

        <div className="w-full">
          {/* --- UNLOCK VIEW --- */}
          {view === 'unlock' && (
            <div className="animate-modalIn">
              <p className="text-gray-500 dark:text-gray-400 mb-8 font-bold text-center">নিরাপত্তার জন্য {pinLength} অক্ষরের পিন দিন</p>
              ...
              {error && (
                <p className="mt-4 text-red-500 font-black text-sm animate-pulse text-center">ভুল পাসওয়ার্ড! আবার চেষ্টা করুন।</p>
              )}
              ...
              {savedSecurityQuestions.length > 0 && !error && (
                <div className="text-center">
                  <button 
                    ...
                    className="mt-12 text-sm font-black text-blue-600 hover:text-blue-500 transition-colors bg-blue-50 dark:bg-blue-900/20 px-6 py-3 rounded-2xl inline-block"
                  >
          ...
          {view === 'setup' && (
            <div className="animate-modalIn">
              <p className="text-gray-500 dark:text-gray-400 mb-8 font-bold leading-relaxed px-4 text-center">আপনার তথ্য সুরক্ষিত রাখতে ৪ বা ৬ অক্ষরের পিন সেট করুন</p>
          ...
          {view === 'recovery_questions' && (
            <div className="animate-modalIn">
              <p className="text-gray-500 dark:text-gray-400 mb-8 font-bold leading-relaxed text-center">পাসওয়ার্ড পুনরুদ্ধার করতে নিচের প্রশ্নগুলোর সঠিক উত্তর দিন</p>
          ...
          {view === 'reset_password' && (
            <div className="animate-modalIn">
              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-3xl mb-8 border-2 border-emerald-500/20">
                <p className="text-emerald-600 dark:text-emerald-400 font-black text-sm text-center">পাসওয়ার্ড রিসেট করতে নতুন পিন দিন।</p>
              </div>
        ...
        <div className="h-10 flex-shrink-0"></div> {/* Bottom spacer for better scrolling */}
      </div>
